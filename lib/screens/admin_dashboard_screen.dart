                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Manage all aspects of the EduCyp platform',
                      ...
                      _buildActionCard(
                        ...
                        () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Partner management will be available in Phase 5')),
                          );
                        },
                      ),
                      _buildActionCard(
                        ...
                        () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(content: Text('Program management will be available in Phase 6')),
                          );
                        },
                      ),
                      _buildActionCard(
